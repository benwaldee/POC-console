            ...
            {displaySearchResults && loadArr &&
                <div className='Search_search-results-wrap-table'>
                    <div className='Search_flex'>
                        <div className='DeliverySearch_table-header'>
                            <div className='DeliverySearch_table-header-val'>Load Number</div>
                            <div className='DeliverySearch_table-header-val'>Customer Number</div>
                            <div className='DeliverySearch_table-header-val'>Dealer</div>
                            <div className='DeliverySearch_table-header-val'>Ship Date</div>
                            <div className='DeliverySearch_table-header-val'>Delivery Date</div>
                        </div>
                        {matchedDeliveries?.map((delivery, index) =>
                            <div
                                className={`DeliverySearch_table-entry DeliverySearch_table-entry-last-${matchedDeliveries.length - 1 === index}`}
                            ...
                            >
                                <div className='DeliverySearch_table-entry-val '>{delivery.loadNum}</div>
                                <div className='DeliverySearch_table-entry-val'>{delivery.dealer.customerNumber}</div>
                                <div className='DeliverySearch_table-entry-val'>{delivery.dealer.customerName}</div>
                                <div className='DeliverySearch_table-entry-val'>{delivery.shipDate}</div>
                                <div className='DeliverySearch_table-entry-val'>{delivery.estDeliverDate}</div>
                            </div>
